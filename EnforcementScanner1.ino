...
#define RX_PIN_S1C1     2
#define TX_PIN_S1C1     3
#define RX_PIN_S1C2     4
#define TX_PIN_S1C2     5

#define REPETITIONS     5

MFRC522 mfrc522(SS_PIN, RST_PIN);  // Create MFRC522 instance
SoftwareSerial BTserial1(RX_PIN_S1C1, TX_PIN_S1C1); // RX | TX
SoftwareSerial BTserial2(RX_PIN_S1C2, TX_PIN_S1C2); // RX | TX
...
uint8_t rules[9] = {'A', 'S', 130, 'L', 1, 'B', 1, 'T', 10}; 
